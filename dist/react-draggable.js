	...
	var DraggableCore = function (_React$Component) {
	  ...
	  function DraggableCore() {
	    ...
	    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = DraggableCore.__proto__ || Object.getPrototypeOf(DraggableCore)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      ...
	      var _snapToGrid = snapToGrid(_this.props.grid, x, y);
	      ...
	      if (_this.state.settingPosition == true) {
	        return;
	      }
	      ...
	      if (Array.isArray(_this.props.grid)) {
	        ...
	        var _snapToGrid3 = snapToGrid(_this.props.grid, _deltaX, _deltaY);

	        var _snapToGrid4 = slicedToArray(_snapToGrid3, 2);

	        _deltaX = _snapToGrid4[0];
	        _deltaY = _snapToGrid4[1];

	        if (!_deltaX && !_deltaY) return; // skip useless drag
	        x = _this.state.lastX + _deltaX, y = _this.state.lastY + _deltaY;

	        var _snapToGrid5 = snapToGrid(_this.props.grid, x, y);

	        var _snapToGrid6 = slicedToArray(_snapToGrid5, 2);
